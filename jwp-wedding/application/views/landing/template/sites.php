...
<head>
    ...
    <!-- Favicon -->
    <link href="<?= base_url('assets/files/') . $getDataWeb->logo; ?>" rel="icon">
...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                <a href="" class="navbar-brand">
                    <img class="img-fluid" src="<?= base_url('assets/files/') . $getDataWeb->logo; ?>" alt="Logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="<?= base_url('Pesanan') ?>" class="nav-item nav-link <?= ($url == 'Pesanan') ? 'active' : ''; ?>">Pesanan</a>
    ...
    <!-- Footer Start -->
    <div class="container-fluid bg-dark footer mt-5 py-8 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary me-3"></i><?= $getDataWeb->phone_number2; ?></p>
                </div>
                <div class="col-lg-4 col-md-4">
                    <p class="mb-2"><i class="fa fa-envelope text-primary me-3"></i><?= $getDataWeb->email1; ?></p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary me-3"></i><?= $getDataWeb->email2; ?></p>
                </div>
                <div class="col-lg-4 col-md-4">
                    <p class="mb-2"><i class="fa fa-clock text-primary me-3"></i><strong><?= $getDataWeb->header_bussines_hour; ?></strong></p>
                    <p class="mb-2"><strong><?= $getDataWeb->time_bussines_hour; ?></strong></p>
                    <div class="d-flex pt-3">
                        ...
                        <a class="btn btn-square btn-primary rounded-circle me-2" href="<?= $getDataWeb->youtube_url; ?>"><i class="fab fa-youtube"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="fw-medium" href="#"><?= $getDataWeb->website_name; ?></a>, All Right Reserved.
                </div>
            </div>
        </div>
    </div>
