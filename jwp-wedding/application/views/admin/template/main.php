...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="<?= base_url('assets/files/') . $getDataWeb->logo; ?>" />
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="http://localhost/jwp-wedding/"><img src="<?= base_url('assets/files/') . $getDataWeb->logo; ?>" class="mr-2" alt="logo"/><span style="font-size: 14px;"><?= $title ?></span></a>
        <a class="navbar-brand brand-logo-mini" href="http://localhost/jwp-wedding/"><img src="<?= base_url('assets/files/') . $getDataWeb->logo; ?>" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="<?= base_url('assets/files/') . $getDataWeb->logo; ?>" alt="profile"/>
            </a>
    ...
    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2024. <?= $title ?></span>
    </div>
</footer> 
    <!-- partial -->
    </div>
