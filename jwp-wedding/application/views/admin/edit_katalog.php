                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputName1" name="package_name" placeholder="Paket Name" value="<?= $katalog->package_name; ?>" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="exampleSelectStatusPublish" name="status_publish">
